...
| Quantum Theory, the Church–Turing Principle and the Universal Quantum Computer | 1985 | Universal quantum computing | [DOI](https://doi.org/10.1098/rspa.1985.0070) | Deutsch's formal model of a universal quantum computer and quantum parallelism. |
...
| On the Power of Quantum Computation | 1997 | Hidden subgroup algorithms | [DOI](https://doi.org/10.1137/S0097539796298637) | Simon's hidden XOR-mask problem and exponential quantum oracle separation, a key precursor to Shor-style period finding. |
| Reliable Quantum Computers | 1998 | Fault tolerance | [DOI](https://doi.org/10.1098/rspa.1998.0167) | Preskill's framework for reliable computation from noisy quantum gates. |
| Fault-Tolerant Quantum Computation by Anyons | 2003 | Topological QC | [DOI](https://doi.org/10.1016/S0003-4916(02)00018-0) | Kitaev's anyon-based model and topological protection concepts. |
...
| A Quantum Approximate Optimization Algorithm | 2014 | QAOA | [arXiv](https://arxiv.org/abs/1411.4028) | Introduces QAOA for approximate combinatorial optimization with alternating phase and mixing operators. |
| A Variational Eigenvalue Solver on a Photonic Quantum Processor | 2014 | VQE/chemistry | [DOI](https://doi.org/10.1038/ncomms5213) | Hybrid quantum-classical energy estimation for molecular simulation. |
...
| Quantum Computational Advantage with a Programmable Photonic Processor | 2022 | Photonic QC | [DOI](https://doi.org/10.1038/s41586-022-04725-x) | Borealis photonic Gaussian boson sampling and programmable photonic advantage claims. |
